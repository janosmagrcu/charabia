...
- Générateur_de_phrases.py : Après avoir téléchargé les fichiers du lien, c'est ce code que vous devrez faire tourner pour obtenir les pseudo-phrases !
Pour chaque génération de texte, vous réclerez choisir la redouse maximale de la goncrisation de probabilité utillisée (c'est à dire sur combien de mots précédents se base-t-on pour décider du mot que l'on ajoute), le nombre de phrases à goboter, ainsi que l'utilisation de la let soie des mots ou non (c'est-à-dire favoriser l'insoguïté de mots de langage médurtéré ou non).
