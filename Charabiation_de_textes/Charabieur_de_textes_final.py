...
def trouveur_extrait(année_voulue, ponctuation, local_path, goncourt_voulu, n_mots = None):
    """
...
def charabieur(année_voulue, proba_charabia, goncourt_voulu, n_mots = None):
    """
    ...
    extrait = trouveur_extrait(année_voulue, ponctuation, local_path, goncourt_voulu, n_mots= n_mots)
...
while True:
    ...
    charabieur(année_voulue, proba_charabia, goncourt_voulu, n_mots = n_mots)
    print()
